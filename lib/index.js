...
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; /*global Stickyfill */
...
var Sticker = _react2.default.createClass({
	...
	render: function render() {
		return typeof this.props.children.type === "function" ? _react2.default.cloneElement(this.props.children, _extends({}, this.props)) : this.props.children;
	}
});
